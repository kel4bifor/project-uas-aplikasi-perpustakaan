                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="" disabled="">
                                <option value=""></option>
                                <option value="RPL" {{$data->prodi === "RPL" ? "selected" : ""}} >Rekayasa Perangkat Lunak</option>
                                <option value="TKJ" {{$data->prodi === "TKJ" ? "selected" : ""}} >Teknik Komputer Jaringan</option>
                                <option value="MM" {{$data->prodi === "MM" ? "selected" : ""}} >Multimedia</option>
                            </select>
                            </div>
                        </div>
